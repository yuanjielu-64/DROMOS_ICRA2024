...
const char KW_GenerateInstances[] = "GenerateInstances";
const char KW_Initial[] = "Initial";
const char KW_AdjustTimeBounds[] = "AdjustTimeBounds";

const int KEY_DRAW_OBSTACLES = 'o';
const int KEY_DRAW_STATE = 'b';
const int KEY_RUN_STEER = '[';
const int KEY_RUN_DECOMPOSITION_SELECT_REGION = ']';
const int KEY_RUN_PAUSE = 'p';
