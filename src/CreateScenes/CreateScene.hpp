...
public:
  CreateScene(void)
      ...
      , m_shapeMaxNrVertices(Constants::SHAPE_MAX_NR_VERTICES)
      , m_shapeThickness(Constants::SHAPE_THICKNESS)
      , m_shapeProbL(Constants::SHAPE_PROBABILITY_L)
      , m_shapeProbU(Constants::SHAPE_PROBABILITY_U)
  ...
  virtual void SetGrid(const Grid *const grid)
  {
    ...
    virtual bool AddObject(const int gid, const int nrTries, const double r1 = -1, const double r2=-1, const double c[] = NULL, const double x2 = -1, const double y2 = -1);
    virtual bool AddPolygon2D(const int gid, const int nrTries, const double r1 = -1, const double r2=-1, const double c[] = NULL, const double x2 = -1, const double y2 = -1);
    virtual bool AddBox3D(const int gid, const int nrTries, const double r1 = -1, const double r2= -1, const double c[] = NULL, const double x2 = -1, const double y2 = -1);
  ...
  virtual void RandomPlacement(Polygon2D &poly, const double r1 = -1, const double r2=-1, const double c[] = NULL, const double x2 = -1, const double y2 = -1);
