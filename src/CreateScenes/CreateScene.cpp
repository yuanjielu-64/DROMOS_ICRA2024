...
namespace Antipatrea {
    ...
    bool
    CreateScene::AddPolygon2D(const int gid, const int nrTries, const double r1, const double r2, const double c[], const double x2, const double y2) {
    ...
    bool
    CreateScene::AddBox3D(const int gid, const int nrTries, const double r1, const double r2, const double center[], const double x2, const double y2) {
        double box[6];
        double c;
        double d;
