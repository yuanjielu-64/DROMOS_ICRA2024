...
public:
  ...
  virtual void SetupFromParams(Params &params)
  {
    ...
    SetCounterFromExploreToFollow(params.GetValueAsInt(Constants::KW_CounterFromExploreToFollow, GetCounterFromExploreToFollow()));
    SetCounterFromFollowToExplore(params.GetValueAsInt(Constants::KW_CounterFromFollowToExplore, GetCounterFromFollowToExplore()));
