...
namespace Antipatrea {
        ...
        for (int i = 0; i < nrGoals; ++i) {
            ...
            if (data && data->m_params) {
                ...
                if (r != NULL) {
                    ...
                    r->SetReward(RandomUniformReal(Constants::KW_GoalRewardMin, Constants::KW_GoalRewardMax));
                    r->SetDecay(RandomUniformReal(Constants::KW_GoalDecayMin, Constants::KW_GoalDecayMax));
                    m_goals.push_back(r);
    ...
    void Problem::DrawGoals(void) {
        ...
        for (int i = m_goals.size() - 1; i >= 0; --i) {
            ...
            sprintf(msg1, "Nr. of Samples: >%d;  Planning Time: %.2f seconds", 3000, totalTime);
